...
class MovielistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movielist" do
    assert_difference("Movielist.count") do
      post movielists_url, params: { movielist: { description: @movielist.description, directorname: @movielist.directorname, language: @movielist.language, name: @movielist.name } }
    end
  ...
  test "should update movielist" do
    patch movielist_url(@movielist), params: { movielist: { description: @movielist.description, directorname: @movielist.directorname, language: @movielist.language, name: @movielist.name } }
